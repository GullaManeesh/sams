...
export const Navbar = ({ onUploadClick, user }) => {
            ...
            <div className="flex ml-4 sm:ml-0 items-center space-x-8">
              ...
              <div className="hidden md:flex items-center space-x-8">
                ...
                <button
                  ...
                  className="cursor-pointer flex items-center space-x-2 text-gray-600 font-medium hover:text-indigo-600 transition-colors py-1 px-2 rounded-md">
